...
st.title("Colorectal Histology Image Classification [Demo]")
st.text("This is an AI/ML system that analyzes coloectal histology texture images and suggests possible diagnoses.")
st.text("NOTE: This is just a demo. It cannot be used for professional medical/radiological diagnosis.")
st.subheader("Give it a go!")
st.text("Upload a tissue image on the side-bar and watch the ML magic happen!")
st.text("[A default image slide with tumors is loaded, just for convenience] ")
st.text("A diagnosis, its probability and attribution map will appear below. please wait patiently...")
